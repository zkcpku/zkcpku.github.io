...
aidn.event = {
    ...
    add: function(e, t, n, i, o) { (aidn.config.touchEnabled ? this.addTouchEvent: this.addMouseEvent)(e, t, n, i, o)
    },
    remove: function(e, t, n, i, o) { (aidn.config.touchEnabled ? this.removeTouchEvent: this.removeMouseEvent)(e, t, n, i, o)
    },
...
_active = !1; (_active = "undefined" == typeof swfobject || swfobject.hasFlashPlayerVersion("9") && !aidn.util.checkMobile()) || (swffit.fit = function() {}),
__checkInit(),
aidn.extra = {
    Button: function(e, t) {
        function n() {
...
aidn.AutoAudio = function(e, t, n) {
    ...
    0 == i) { (n = document.createElement("div")).id = "flash_audio",
    ...
    this.stop = function() { (o.stopFunc || o.stop || o.pause).apply(o, arguments)
    },
    this.addEndEvent = function(e) {
        0 != i && o.addEndEvent(e)
    },
